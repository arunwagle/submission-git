...
docker build --pull --no-cache -t arunwagle123/ibm_cloudfunctions_repo:submission_intake_6 .

docker push arunwagle123/ibm_cloudfunctions_repo:submission_intake_6
